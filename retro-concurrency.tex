...
\affiliation{
  \institution{\small University of Cambridge Computer Laboratory and OCaml Labs}            %% \institution is required
	\city{\small Cambridge}
	\country{\small UK}
}
...
\begin{abstract}
Effect handlers have been gathering momentum as a mechanism for non-local
