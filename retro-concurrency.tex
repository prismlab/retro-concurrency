...
\lstset{
      ...
      stringstyle=\color{MidnightBlue},
			...
			keywords=[3]{effect,perform,continue,discontinue},
...
\end{minipage}
  \begin{minipage}{0.39\linewidth}
    \centering
    \includegraphics[scale=0.5]{figures/stock_stack}
...
Figure~\ref{fig:stock_stack}), or prints a fatal error (|fatal_error|) if there
