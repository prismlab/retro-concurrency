...
necessary. Similar to Farvardin et al.~\cite{Farvardin20}, we use a \emph{stack
cache} of recently freed stacks in order to speed up allocation.
...
we observed that padding tight loops with a few |nop| instructions, which
changes the loop alignment, can make the code up to 15\% faster. Hence, the
...
\textbf{23ns, 5ns, 11ns and 7ns}, respectively. For reference, the idle
