...
\begin{enumerate}[label=R\arabic*]
	\item \textbf{Backwards compatibility.} Extant OCaml programs \kc{Extant
		better than legacy?} \tk{Existing might be better?} do not break under
    OCaml extended with effect handlers. OCaml code that does not use effect
    handlers will pay negligible performance and memory cost.
...
from the start of the function, which may be potentially very slow. Within each
...
we can get the backtrace of the entire call stack and not just the current
fiber.
