...
code that does not use effect handlers.
...
\item micro-benchmarks covering 1M external calls, 1M callbacks, 1M install handler return, 1M install handler + raise; 4.10.0+stock vs 4.10.0+multicore
