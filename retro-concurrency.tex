...
also include a Go 1.13 version (|go|) that uses \texttt{net/http}~\cite{nethttp}
package. As both OCaml versions are single threaded, the Go benchmark is run with
\texttt{GOMAXPROCS=1}.
