...
executed 10 iterations of the code, ignoring 3 warm-up runs. We observed that
the sequences \texttt{a-b}, \texttt{b-c}, \texttt{c-d} and \texttt{d-e} took
48ns, 10ns, 13ns and 19ns, respectively. For reference, the idle memory latency
for the local NUMA node is 93.2ns.
